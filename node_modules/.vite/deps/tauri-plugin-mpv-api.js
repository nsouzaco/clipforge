...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/external/tslib/tslib.es6.js
...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/core.js
...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/dpi.js
...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/event.js
var TauriEvent;
...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/image.js
...
// node_modules/tauri-plugin-mpv-api/node_modules/@tauri-apps/api/window.js
...
// node_modules/tauri-plugin-mpv-api/dist-js/index.js
...
async function init(mpvConfig, windowLabel) {
  ...
  return await invoke("plugin:mpv|init", {
    mpvConfig,
    windowLabel
  });
}
...
async function command(arg1, arg2, arg3) {
  ...
  const response = await invoke("plugin:mpv|command", {
...
async function setVideoMarginRatio(ratio, windowLabel) {
  windowLabel = windowLabel ?? getCurrentWindow().label;
  return await invoke("plugin:mpv|set_video_margin_ratio", {
    ratio,
    windowLabel
  });
}
var initializeMpv = init;
var destroyMpv = destroy;
var observeMpvProperties = observeProperties;
var listenMpvEvents = listenEvents;
var sendMpvCommand = command;
export {
  COMMON_PROPERTIES,
  DEFAULT_MPV_CONFIG,
  command,
...
//# sourceMappingURL=tauri-plugin-mpv-api.js.map
